-- =====================================================================
--  Sepha-Jo by Lotte — creation des tables (version Railway)
--
--  Sur Railway, la base existe deja : ce script ne cree donc PAS de
--  base, seulement les tables.
--
--  ATTENTION : l'editeur « Data » de Railway n'accepte qu'UNE
--  instruction a la fois. Preferez public/setup.php, qui fait tout en
--  une seule page. Ce fichier reste utile pour phpMyAdmin.
-- =====================================================================
...
--
--  Les TARIFS proviennent du site. Les DUREES (colonne Delay) sont des
--  ESTIMATIONS : elles conditionnent l'espacement des creneaux proposes
--  aux clientes. Corrigez-les depuis l'administration, menu Prestations.
-- =====================================================================
...
-- Le plus simple : ouvrez https://VOTRE-DOMAINE/setup.php.
-- Sinon, generez le hash sur /admin/generate-hash.php puis executez :
