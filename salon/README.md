...
├── public/                     partie visible par les clients
│   ├── index.php
...
4. Ouvrir `http://localhost/salon/admin/generate-hash.php`, saisir le mot de
   passe voulu, exécuter la requête `INSERT` affichée dans phpMyAdmin
5. **Supprimer** `admin/generate-hash.php`
...
et l'administration sur `http://localhost/salon/admin/login.php`.
