# À FAIRE EN PREMIER — installation en local (8 étapes)

> **Vous préférez mettre le site en ligne plutôt qu'en local ?**
> Suivez `RAILWAY.md` à la place : ce fichier-ci décrit l'installation sur
> votre machine avec XAMPP.
...
Ouvrez `http://localhost/salon/public/admin/generate-hash.php`
...
Supprimez le fichier `public/admin/generate-hash.php`.
...
Connectez-vous sur `http://localhost/salon/public/admin/login.php`
...
| Administration | `http://localhost/salon/public/admin/login.php` |
...
├── Dockerfile               déploiement en ligne (Railway)
├── RAILWAY.md               guide de mise en ligne
